...
# grab the paths to the input images in our dataset
	...
	for (i, imagePath) in enumerate(imagePaths):
		...
		image = cv2.imread(media_path + imagePath[1])
...
# result=[[9564,r"C:\Users\HP\PycharmProjects\missing_child\media\1000292807.jpg"]]
# result=[[9565,r"C:\Users\HP\PycharmProjects\missing_child\media\IMG_20250309_105728_D5QaZ45.jpg"]]
result=[]
qry="SELECT * FROM `myapp_missingcase_table`"
res=selectall(qry)
for i in res:
	row=[i['id'],i['childimage']]
	result.append(row)
enf(result)
